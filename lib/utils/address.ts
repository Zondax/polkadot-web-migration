...
/**
 * Legacy function: Replaces the last index in a BIP44 derivation path with a new index.
 * @deprecated Use updateBip44PathIndices({ address: index }) instead for better error handling
...
/**
 * Legacy function: Replaces the account index (3rd component) in a BIP44 derivation path.
 * @deprecated Use updateBip44PathIndices({ account: accountIndex }) instead for better error handling
 * @param bip44Path - The base BIP44 derivation path (e.g. "m/44'/354'/0'/0'/0'")
