...
export function DeepScanModal({ isOpen, onClose, onScan, isScanning = false }: DeepScanModalProps) {
  ...
  }, [accountScanType, addressScanType, accountIndex, accountStartIndex, accountEndIndex, addressIndex, addressStartIndex, addressEndIndex, selectedChain, availableChains])
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Tabs value={accountScanType} onValueChange={(value) => setAccountScanType(value as 'single' | 'range')}>
              ...
              <TabsContent value="range" className="space-y-2 mt-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label htmlFor="account-start-index" className="text-sm font-medium">Start Index</label>
                  ...
                  <div className="space-y-2">
                    <label htmlFor="account-end-index" className="text-sm font-medium">End Index</label>
                    <div className="flex items-center space-x-1">
                      <Button
                        type="button"
                        variant="outline"
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Scanning {Math.max(0, Number.parseInt(accountEndIndex, 10) - Number.parseInt(accountStartIndex, 10) + 1)} account{Math.max(0, Number.parseInt(accountEndIndex, 10) - Number.parseInt(accountStartIndex, 10) + 1) !== 1 ? 's' : ''}
                </p>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Tabs value={addressScanType} onValueChange={(value) => setAddressScanType(value as 'single' | 'range')}>
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="single">Single Address</TabsTrigger>
                <TabsTrigger value="range">Address Range</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="single" className="space-y-2 mt-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  The address index is the fifth component in the BIP44 path
                </p>
              </TabsContent>
              ...
              <TabsContent value="range" className="space-y-2 mt-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label htmlFor="address-start-index" className="text-sm font-medium">Start Index</label>
                    <div className="flex items-center space-x-1">
                      <Button
                        type="button"
                        variant="outline"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="address-end-index" className="text-sm font-medium">End Index</label>
                    <div className="flex items-center space-x-1">
                      <Button
                        type="button"
                        variant="outline"
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Scanning {Math.max(0, Number.parseInt(addressEndIndex, 10) - Number.parseInt(addressStartIndex, 10) + 1)} address{Math.max(0, Number.parseInt(addressEndIndex, 10) - Number.parseInt(addressStartIndex, 10) + 1) !== 1 ? 'es' : ''} per account
                </p>
              </TabsContent>
            </Tabs>
          </div>
        ...
        <DialogFooter>
          ...
          <Button
            onClick={handleScan}
            disabled={isScanning || !isValidScan()}
          >
